...
<head>
    ...
    <title>View Module Schemes</title>
                            ...
                            <?php foreach ($modules as $module): ?>
                                <li class="py-4 hover-rise fade-in">
                                    <div class="flex justify-between items-center custom-font">
                                        ...
                                        <a href="scheme_display.php?module=<?= urlencode($module['module_code']); ?>" class="px-4 py-2 bg-blue-500 btn-assign text-white font-bold rounded-full">
                                            <i class="fas fa-info-circle"></i> View Scheme
                                        </a>
                                    </div>
                                </li>
                            <?php endforeach; ?>
