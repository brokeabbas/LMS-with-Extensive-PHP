...
$sql = "SELECT id, fullname, dob, email, phone, student_number FROM student_info WHERE school_id = ? AND is_active = 1";
...
<head>
    ...
    <title>Manage Existing Students</title>
...
<body class="bg-gray-900">
    <div class="max-w-7xl mx-auto py-10 sm:px-6 lg:px-8">
        <h1 class="text-3xl font-bold text-gray-200 mb-6 text-center">Existing Students at <?php echo htmlspecialchars($school_name); ?></h1>
            ...
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-gray-700 divide-y divide-gray-600 text-white">
                    ...
                    <tr class="table-row">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                            <a href="view_students.php?id=<?php echo $student['id']; ?>" class="text-green-500 hover:text-green-300">View</a>
                            <a href="edit-student.php?id=<?php echo $student['id']; ?>" class="text-indigo-500 hover:text-indigo-300 ml-4">Edit</a>
                            <a href="delete-student.php?student_id=<?php echo $student['id']; ?>" onclick="return confirm('Are you sure you want to disable this student?');" class="text-red-500 hover:text-red-300 ml-4">Disable</a>
                        </td>
                    </tr>
                    <?php endforeach; ?>
                </tbody>
